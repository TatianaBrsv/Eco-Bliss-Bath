describe("Affichage des produits sur la page d’accueil", () => {
    ...
    cy.intercept("GET", /http:\/\/localhost:8081\/products\/\d+/, (req) => {
      ...
      const productsData = {
        ...
        6: {
          ...
          description:
            "La mousse riche et onctueuse nettoie en profondeur en laissant votre peau douce et hydratée.",
          price: 24,
          picture:
            "https://cdn.pixabay.com/photo/2015/01/06/02/56/soap-589824_960_720.jpg",
          varieties: 9,
        },
        7: {
          id: 7,
        ...
        9: {
          ...
          description:
            "Le parfum délicat de lavande vous transporte dans un jardin en fleurs.",
          price: 10,
          picture:
            "https://cdn.pixabay.com/photo/2018/01/30/16/54/herbs-3119132_960_720.jpg",
          varieties: 3,
        },
        10: {
          id: 10,
          ...
          description:
            "Ses propriétés apaisantes aident à calmer les nerfs et à améliorer votre bien-être général.",
          price: 26,
          picture:
            "https://cdn.pixabay.com/photo/2017/05/22/07/34/soap-2333391_960_720.jpg",
          varieties: 3,
        },
      };
  ...
  it("Devrait afficher 3 produits aléatoires sur la page principale", () => {
    ...
    //Vérifier que chaque produit affichés sur la page d'accueil contient les données nécessaires
    ...
    // Choix aléatoire d'un produit sur la page d'accueil
    cy.get('[data-cy="product-home-link"]')
      .its("length")
      .then((length) => {
